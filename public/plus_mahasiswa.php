...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="berkas/css/mahasiswa.css">
</head>
<body>
    <!-- PHP -->
    <?php
    ...
    <nav class="nav_nyoman navbar navbar-expand-sm navbar-dark">
        ...
        <button class="plus_mahasiswa " type="button" data-bs-target="#mahasiswaplus" data-bs-toggle="modal">Tambah Data Mahasiswa</button>
    </nav>
    <!-- ! CLOSE ! -->
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form class="row g-1" action="/mahasiswa" method="POST" id="inputdatamahasiswabro">
                        ...
                        <select class="form-select" aria-label="Default select example" type="text" name="jurusan" id="listjurusan" required>
                ...
                <div class="modal-footer">
                    <button class="bt_nby_broo btn btn-primary" type="submit" form="inputdatamahasiswabro">save data mahasiswa</button>
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form class="g-1" action="" method="POST" id="editdatamahasiswabro">
                        ...
                        <input class="form-control" type="text" name="nama" id="update_nama" placeholder="Masukan Nama" required>
                        ...
                        <label for="nim" class="form-text">Nim</label>
                        <input class="form-control" type="text" name="nim" id="update_nim" placeholder="Masukan Nim" required>
                    </form>
                </div>

                <div class="modal-footer">
                    <button class="bt_nby_broo btn btn-primary" type="submit" form="editdatamahasiswabro">update data mahasiswa</button>
                </div>
            </div>
        </div>
    </div>
